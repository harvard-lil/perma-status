...
parser.add_argument("--offset", help="How many captures back to start", default=0, type=int)
...
while True:
    for obj in objs:
        ...
        last = timestamp
        objects.append((obj['creation_timestamp'], delta, obj['queue_time'], obj['capture_time'], interval, obj['guid']))
